import { processMessageWithTools } from "../mcp/orchestrator";
import { transcribeAudio, GroqError } from "../services/groq";
import { NvidiaError } from "../services/nvidia";
import { getUserApiKeys, buildMissingKeysMessage } from "../services/user-api-keys";
import { getUserSystemPrompt } from "../services/user-config";
import { getUserIdByChatId as getTelegramUserIdByChatId } from "../services/telegram-link";
import {
  createPendingMedia,
  getPendingMedia,
  markMediaConsumed,
} from "../services/pending-media";
import { downloadMediaMessage } from "../services/telegram";
import { logActivity } from "../utils/activity-log";
import { sanitizeUserMessage, buildProtectedSystemPrompt } from "../utils/prompt-sanitizer";
import type { MessagingChannel, IncomingMediaMessage, PendingMedia } from "../types/index";
